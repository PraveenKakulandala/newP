...
<body>
  ...
  <h1 style="text-align: center; color:white;" >Remove Product</h1>
...
<h4 style = "color:white; text-align: center;">Can't you remember the product name? <a href="viewProduct.jsp">See Products list.</a></h4>
